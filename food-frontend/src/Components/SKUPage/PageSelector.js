...
import { skuSearch } from '../../Redux/Actions';
...
const mapStateToProps = state => {
    return {
        offset: state.skus.offset,
        limit: state.skus.limit,
        items: state.skus.items,
        row_count: state.skus.row_count,
        full: state.skus.full,
        end: state.skus.end
    };
};
